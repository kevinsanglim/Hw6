...
function makeScatterPlot(csvData) {
    ...
    let distinctYears = [...new Set(data.map(d => 1980))];
...
function plotPopulation(country, toolChart) {
    ...
    let mapFunctions = drawAxes(axesLimits, "year", "population", toolChart, small_msm, 1);
...
function drawAxes(limits, x, y, svgContainer, msm, tltip) {
    ...
    if (tltip == 1) {
    yAxis = yAxis.tickFormat(function(d){return d/1000000000 + " B"});
    }
    svgContainer.append('g')
